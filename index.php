                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    <div class="text-center">
                                        <img src="imgs/login/logo.webp" style="width: 185px;" alt="logo">
                                        <h4 class="mt-1 mb-5 pb-1">We are Monkey's Team</h4>
                                    </div>
                                    <form action="logic/login.php" method="POST">
                                        <p>Por favor, inicie sesión en su cuenta</p>
                                        <div class="form-outline mb-4">
                                            <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Dirección de correo electrónico" />
